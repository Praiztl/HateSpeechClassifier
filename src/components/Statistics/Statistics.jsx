    ...
    <>
          ...
          <li class="nav-item">
            ...
            >
              <svg viewBox="0 0 24 24" style={styles.Icon}>
                ...
                <path d="M7 4h10v15H7zM3 6h2v11H3zm16 0h2v11h-2z"></path>
              </svg>
            </Link>
          </li>
          <li class="nav-item">
      ...
      <main id="dashboard" class="dashboard">
        <div class="row">
          <div class="col-lg-8">
            <div class="row">
              <div class="col-xxl-4 col-md-12">
                <h2 class="title">Tweet Statistics</h2>
                <div class="analyzed mt-4">
                  <div class="tweets">
              ...
              <div class="col-xxl-4 col-xl-12">
                <div class="contain mt-4">
                  <div class="goal">
                    <svg viewBox="0 0 512 512" style={styles.Iconin}>
                  ...
                  <div class="goal">
                    <svg viewBox="0 0 576 512" style={styles.Iconin}>
              ...
              <div class="col-12">
                <div class="perform mt-4">
                  <div class="per">
                    <h3 class="title">Performance</h3>
                  </div>
                  <div class="content">
                    <div class="tweetsbookmark">
                      <div class="svg">
                        <svg viewBox="0 0 24 24" style={styles.Iconp}>
                    ...
                    <div class="tweetsbookmark">
                      <div class="svg diff">
                        <svg viewBox="0 0 448 512" style={styles.Iconp}>
          ...
          <div class="col-lg-4">
            <div class="activity">
              <h3 class="subtitle">My Actvity</h3>
              <div class="board">
                <h6>Monday</h6>
                <div class="profile">
