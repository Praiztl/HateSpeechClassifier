...
import './Home.css';
import trend from '../../assets/img/trend.jpeg'
import tweet from '../../assets/img/tweet.jpeg'
...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <li class="nav-heading">Classification</li>
  <li class="nav-item">
  ...
  </svg><span>Accuracy</span>
    </a>
    
  </li>
  <li class="nav-heading">Sample Tweets</li>
  <li class="nav-item">
    <a class="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
      <img src={tweet} alt="" /><span>Tweets Analysis</span>
    </a>
