...
const Feedback = () => {
    ...
    const handleClick = (emoji) => {
      if (selectedEmoji === emoji) {
        setSelectedEmoji(null); // Unselect if already selected
      } else {
  ...
  return (
    ...
    <section id="sentiment" class="sentiment">
  <div class="container " >
      <div class="mt-5 mt-lg-0 d-flex align-items-center justify-content-center">
        <form class="sentiment-form">
          <div class="row">
            <h2>Rate the tweet'sentiment</h2>
            <div className="emoji d-flex ">
            <div className={`poop ${selectedEmoji === 'poop' ? 'selected' : ''}`} onClick={() => handleClick('poop')} >
  ...
  <div className='neutral'><svg style={styles.Icon}  viewBox="0 0 512 512">
  ...
  <div className='huh'> <svg style={styles.Icon}  viewBox="0 0 512 512">
  ...
  <div className='mad'> <svg style={styles.Icon}  viewBox="0 0 512 512">
  ...
  <div className='heart'> <svg style={styles.Icon}  viewBox="0 0 512 512">
    <path d="M0 190.9V185.1C0 115.2 50.52 55.58 119.4 44.1C164.1 36.51 211.4 51.37 244 84.02L256 96L267.1 84.02C300.6 51.37 347 36.51 392.6 44.1C461.5 55.58 512 115.2 512 185.1V190.9C512 232.4 494.8 272.1 464.4 300.4L283.7 469.1C276.2 476.1 266.3 480 256 480C245.7 480 235.8 476.1 228.3 469.1L47.59 300.4C17.23 272.1 .0003 232.4 .0003 190.9L0 190.9z">
            ...
            <div class="form-group">
                <label htmlFor="write">Write your analysis</label>
              <input type="text" name="write" class="form-control-write" id="write" required placeholder="What is the sentiment of the tweet? Provide detailed feedback."/>
            </div>
            
          </div>
          <div class="form-group ">
            <label htmlFor="title">Title of your analysis</label>
            <input type="text" class="form-control-title" name="title" id="title" required placeholder="Enter keywords or hashtags"/>
          </div>
          
          <div class="text-start"><button type="submit" className='sub-btn'>Submit analysis</button></div>
        </form>
      </div>
